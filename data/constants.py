...
class RELATIONSHIP_LEVEL_NAMES:
    ...
    _names = {
        0: f"💫 Знакомые",
        1: f"🌱 Друзья",
        2: f"{EMOJI.FIRE_MID} Близкие друзья",
        3: f"{EMOJI.COMPAT} Лучшие друзья",
        4: f"{EMOJI.CROWN} Души",
    }
...
class Format:
    ...
    VERIFICATION_REQUEST = (
        "📸 Пришли <b>селфи с листком бумаги</b>, на котором написано «Искра» и сегодняшняя дата.\n"
...
# Алиас для RelationshipLevel.threshold (enums.py): индекс уровня -> порог очков.
