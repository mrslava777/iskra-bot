...
class Relationship:
    ...
    FIX: пороги пересчитаны для лучшей геймификации.
    Было: [0, 50, 150, 350, 750] — слишком быстрый старт, слишком долгий финал.
    Стало: [0, 15, 50, 150, 400] — каждый уровень ощутим, но не утомителен.
    """
    THRESHOLDS = [0, 15, 50, 150, 400]
    MAX_LEVEL = 4

    # Вехи между основными уровнями — для микро-достижений
    MILESTONES = {
...
"
    ...
    BLIND_DATE_INTRO = """🎭 <b>Свидание вслепую</b>
...
Можешь пока листать ленту — я напишу, когда найду."""
    BLIND_DATE_FOUND = """✨ <b>Собеседник найден!</b>
...
если тоже хочешь увидеть анкету."""
    ...
    TICKET_SENT = """✅ <b>Обращение отправлено!</b>
...
25 сообщений — вы уже не strangers."
...
🏆 {}{}"
    ...
    TICKET_CAPTION = """📩 <b>Тикет #{}</b>
<b>Категория:</b> {}
<b>Пользователь:</b> {} ({})
<b>ID:</b> <code>{}</code>
<b>Сообщение:</b>
{}"""
    ADMIN_REPLY_PROMPT = """✏️ Напиши ответ пользователю <code>{}</code>:
...
class NSFWThreshold:
    ...
    NUDITY = 0.75          # AI-score: точно NSFW (блокировка)
    VIOLENCE = 0.70        # AI-score: насилие (блокировка)
    SUSPICIOUS = 0.40      # AI-score: подозрительно (ручная проверка)
    AUTO_BAN_STRIKES = 3   # Количество страйков до автобана
