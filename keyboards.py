...
def browse_kb(uid: int, has_extra_photos: bool = False, has_voice: bool = False) -> InlineKeyboardMarkup:
    rows = [
        [
    ...
    if has_voice:
        rows.append([
            InlineKeyboardButton(text="🎙 Голосовое", callback_data=f"sw:voice:{uid}"),
        ])
    rows.append([
...
def profile_kb(has_daily: bool = False, has_voice: bool = False) -> InlineKeyboardMarkup:
    rows = [
        [
    ...
    if has_voice:
        rows.append([
            InlineKeyboardButton(text="🎙 Изменить голосовое", callback_data="ed:voice"),
            InlineKeyboardButton(text="🗑 Удалить", callback_data="ed:del_voice"),
        ])
    else:
        rows.append([InlineKeyboardButton(text="🎙 Добавить голосовое", callback_data="ed:voice")])
    rows.append([InlineKeyboardButton(text="🎯 Ответить на вопрос дня", callback_data="ed:daily")])
    if has_daily:
...
def voice_reg_kb() -> InlineKeyboardMarkup:
    return InlineKeyboardMarkup(
        inline_keyboard=[
            [InlineKeyboardButton(text="🎙 Записать голосовое", callback_data="regvoice:record")],
            [InlineKeyboardButton(text="⏭ Пропустить", callback_data="regvoice:skip")],
        ]
    )


def voice_cancel_kb() -> InlineKeyboardMarkup:
    """Клавиатура отмены при записи голосового в профиле."""
    return InlineKeyboardMarkup(
        inline_keyboard=[
